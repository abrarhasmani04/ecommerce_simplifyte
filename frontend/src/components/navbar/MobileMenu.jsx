  ...
  return (
    <div className="md:hidden">
      ...
      <button
        ...
        className="rounded-lg p-2 text-gray-600 hover:bg-gray-100 hover:text-blue-600 transition-colors"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-gray-100 px-3 py-4">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-red-500 hover:bg-red-50 transition-colors"
          >
